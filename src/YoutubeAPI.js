class youtubeAPI {
    ...
    getUrlWithQuery = (query, nextPageToken) => {
        ...
        return query ? url.toString() : this._url.toString();
    }

    handleLoadData = (xhr) => {
        this.onLoadData(xhr.target.response);
        // update the state of the component with the result here
        // this.setState({ snippetsFormYoutube: this.response, nextPageToken: this.response.nextPageToken, prevPageToken: this.response.prevPageToken });
    }
